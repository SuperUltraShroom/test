...
moveSpeed = partyManager.character[char].walkSpeed //***NEW*** this is here just in case
...
//***NEW***Here's where we check if we're running or not. This saves a ton of lines compared to my implementation.
